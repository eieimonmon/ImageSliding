package com.ptzp.viewpaper

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.os.Handler
import androidx.viewpager.widget.ViewPager
import com.ptzp.viewpaper.adapter.MoviePaperAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    private val myImageList = intArrayOf(R.drawable.chair, R.drawable.chairone, R.drawable.chairtwo)
    ...
    private fun init() {
        ...
        mPager!!.adapter = MoviePaperAdapter(this@MainActivity, this.imageModelArrayList!!)
